...
export class CreateCarDto {
  ...
  @ApiPropertyOptional({
    description: 'Owner user ID (auto-set for car_owner role)',
  })
  @IsOptional()
  @IsInt()
  ownerId?: number;
  ...
  @ApiPropertyOptional({
    example: 'sedan',
    description: 'Car type (sedan, SUV, truck, etc.)',
  })
  @IsOptional()
  @IsString()
  car_type?: string;
  ...
  @ApiPropertyOptional({
    example: '11012',
    description: 'Postal code for location filter',
  })
  @IsOptional()
  @IsString()
  postal_code?: string;
  ...
  @ApiPropertyOptional({
    example: 'A comfortable car for long drives',
