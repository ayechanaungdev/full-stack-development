...
export class ChatController {
    ...
    async sendMessage(
        ...
        this.chatGateway.emitToUser(body.receiverId, 'newMessage', formattedMessage);
        this.chatGateway.emitToUser(req.user.userId, 'newMessage', formattedMessage);
    ...
    async markMessagesAsRead(
        ...
        const result = await this.chatService.markMessagesAsRead(req.user.userId, body.partnerId);
        if (result.count > 0) {
