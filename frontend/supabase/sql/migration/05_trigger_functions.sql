-- 01. This migration adds a trigger function to handle new user creation.
...
-- 01.2 The trigger needs to run on both INSERT (for Google users) and UPDATE (for Email users)
...
-- 02. This migration adds a trigger function to handle notifications for booking events.
...
-- 02.1 The trigger needs to run on both INSERT (for new bookings) and UPDATE (for booking status changes)
...
-- 03. This migration adds a trigger function to handle notifications for new chat messages.
...
-- 04. This migration adds a trigger function to handle notifications for new daily reports.
...
-- 05. This migration adds a trigger function to handle notifications for new cars added by owners.
...
-- 06. This migration adds a trigger function to handle notifications for new inquiries submitted by users.
...
-- 06.1 The trigger needs to run on INSERT for new inquiries.
...
-- 07. This migration adds a scheduled function to keep the Supabase project alive by making periodic HTTP requests.
...
-- 08. This migration adds a trigger function to handle notifications for changes in car status by admin.
...
-- 09. This migration adds a trigger function to sync read status across notifications when a booking, message, or daily report is marked as read.
...
-- 09.1 The trigger needs to run on UPDATE for bookings.
...
-- 09.2 The trigger needs to run on UPDATE for messages.
...
-- 09.3 The trigger needs to run on UPDATE for daily reports.
